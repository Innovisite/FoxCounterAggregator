    ...
    directive('fcaGraphKpi', function () {
        return {
            ...
            '</ul>'
                    ...
                    $scope.onMainSiteSelectionChange = function () {
                        $scope.updateIndicators();
                        $scope.updateSelectedRange();
                        $scope.update();
                    };
                    ...
                    $scope.updateIndicators = function () {
                        ...
                        if ($scope.params.sites.length > 0 &&
                            ...
                            var selSite = $scope.itemsSelected.length > 0 ?
                                $scope.itemsSelected[0] : $scope.params.sites[0];
                    ...
                    function updateOnPeriod(period, data, chartsDataStyle, chartsData, chartsLegends, preKey) {
                        if ($scope.kpi.haveIndicator($scope.indicatorSelected.id)) {
                            for (var i = 0; i < $scope.itemsSelected.length; ++i) {
                                if ($scope.itemsSelected[i] !== undefined) {
                                    var idx = _.findIndex(data, {
                                        "id": $scope.itemsSelected[i].id
                                    });
                                    ...
                                    var key = preKey + "_" + $scope.itemsSelected[i].id +
                                    ...
                                    var label = $scope.getItemName($scope.itemsSelected[i].id) +
                    ...
                    function clearWidgetStyle(style) {                        
                        $scope.style = Object.assign({}, style.json);                        
                    }
                    ...
                    $scope.update = function () {
                        ...
                        WidgetStyleService.getStyle($scope.widgetId).
                            then(function (style) {
                                ...
                                if ($scope.rangeSelected.id !== undefined && $scope.indicatorSelected.id !== undefined) {
                                    ...
                                    if ($scope.periodComparisonSelected) {
                                        ...
                                        if ($scope.itemsSelected[1] === undefined) {
